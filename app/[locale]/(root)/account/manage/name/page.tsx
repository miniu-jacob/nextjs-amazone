// app/[locale]/(root)/account/manage/name/page.tsx
        ...
        <Card className="max-w-2xl">
          <CardContent className="flex justify-between flex-wrap p-4">
            <p className="text-sm py-2">
              If you want to change the name associate with you {site.name}&apos;s account, you may do so below. Be sure to click the Save
