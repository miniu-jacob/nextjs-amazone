                  ...
                  <Form {...form}>
                    <form method="post" onSubmit={form.handleSubmit(onSubmit)}>
                      <DialogHeader>
                        ...
                        <DialogDescription>{t("Share your thoughts with other customers")}</DialogDescription>
                      </DialogHeader>
                      ...
                      {/* DIALOG FOOTER */}
                      <DialogFooter>
                        <Button type="submit" size={"lg"} disabled={form.formState.isSubmitting} className="text-sm">
