      ...
      <form method="post" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input placeholder={t("Product.Enter product name")} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem className="w-full">
                ...
                <FormControl>
                  <div className="relative">
                    <Input placeholder={t("Product.Enter product slug")} {...field} className="pl-8" />
                    <button
                      type="button"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input placeholder={t("Product.Enter category")} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input placeholder={t("Product.Enter brand")} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <div className="flex flex-col gap-5 md:flex-row">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel>{t("Product.List Price")}</FormLabel>
                <FormControl>
                  <Input placeholder={t("Product.Enter product list price")} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel>{t("Product.Net Price")}</FormLabel>
                <FormControl>
                  <Input placeholder={t("Product.Enter product price")} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel>{t("Product.Count In Stock")}</FormLabel>
                <FormControl>
                  <Input type="number" placeholder={t("Product.Enter product count in stock")} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Textarea placeholder={t("Product.Tell us a little bit about the product")} className="resize-none" {...field} />
                </FormControl>
              </FormItem>
            )}
          />
