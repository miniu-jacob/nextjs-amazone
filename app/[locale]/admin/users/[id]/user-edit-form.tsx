// app/[locale]/admin/users/[id]/user-edit-form.tsx
      ...
      <form method="post" className="space-y-8 max-w-xl" onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input placeholder={t("Common.Enter your email")} {...field} disabled />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <div>
          ...
          <FormField
            ...
            name="role"
            render={({ field }) => (
              <FormItem className="flex space-x-4 items-center text-nowrap">
        ...
        <div className="flex-between">
          <Button type="submit" disabled={form.formState.isSubmitting}>
            ...
            {form.formState.isSubmitting
              ? t("Common.Submitting")
              : t("Common.type name", { type: t("Common.Update"), name: t("Common.User") })}
          </Button>
